...
// ─── Dino
// ────────────────────────────────────────────────────────────────────
const uint8_t PROGMEM dino[F_DINO * W_DINO] = {0x23, 0x3b, 0xfe, 0x38, 0x30, 0xe0, 0x30, 0x38};
...
// ─── Ghost
// ────────────────────────────────────────────────────────────────────
const uint8_t PROGMEM ghost[F_GHOST * W_GHOST] = {0x7c, 0xbe, 0x77, 0xbf, 0x77, 0xbf, 0x7e, 0x34};
...
// ─── Mario
// ────────────────────────────────────────────────────────────────────
const uint8_t PROGMEM mario[F_MARIO * W_MARIO] = {0x00, 0xd6, 0x7b, 0x57, 0x5b, 0x7f, 0xde, 0x00};

// ─── Pacman
// ────────────────────────────────────────────────────────────────────
const uint8_t pacman1[] PROGMEM FLASH_BITMAP = {
...
const uint8_t pacman2[] PROGMEM FLASH_BITMAP = {
    0x00, 0x81, 0xc3, 0xe7, 0xff, 0x7e, 0x7e, 0x3c,
...
// ─── Wave
const uint8_t wave[] PROGMEM FLASH_BITMAP = {
